...
<body>
	...
	<main>
		<div class="container-fluid">
			<br>
			<div class="row">
				<div class="col-sm-6"><h2><b>Daftar laporan pegawai</b></h2></div>
			</div>
				...
				<tbody>
					...
					while ($data = mysqli_fetch_assoc($query)){ ?>
						<tr>
							...
							<td><a href="lapor.php?id=<?php echo $data['id_pegawai'] ?>" class="btn btn-primary">Slip</a> <a href="lembur.php?id=<?php echo $data['id_pegawai'] ?>" class="btn btn-warning">Lembur</a></td>
