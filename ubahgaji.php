...
include 'koneksi.php';
$id = $_GET['id'];
$query = mysqli_query($koneksi,"SELECT * FROM bagian WHERE id_bagian = '$id'");
$data = mysqli_fetch_assoc($query);
if (isset($_POST['submit'])) {
	$harga = $_POST['harga'];
	$ubah = mysqli_query($koneksi,"UPDATE bagian SET gaji='$harga' WHERE id_bagian = '$id'");
	if ($ubah) {
		echo "<script>alert('gaji berhasil di ubah');
			...
			<div class="card" style=" width: 600px;">
				<div class="card-header" style=" background-color:#00a98f; color: white; float: left; ">
					<div class="row">
						...
						<div class="col-sm-12 pt-2"><h5 align="center">Gaji <?php echo $data['bagian'] ?></h5></div>
						...
						<div class="col-sm-12">
							<form method="POST">
								<div class="form-group">
									<label for="exampleInputPassword1">masukan nominal gaji</label>
									<input type="number" value="<?php echo $data['gaji'] ?>" required name="harga" class="form-control" id="exampleInputPassword1">
								</div>
