<?php 
include 'koneksi.php';
$query = mysqli_query($koneksi,"SELECT * FROM no_lembur WHERE id_harga = 1");
$data = mysqli_fetch_assoc($query);
if (isset($_POST['submit'])) {
	$harga = $_POST['harga'];
	$ubah = mysqli_query($koneksi,"UPDATE no_lembur SET harga='$harga' WHERE id_harga = 1");
	if ($ubah) {
			...
			<div class="card" style=" width: 600px;">
				<div class="card-header" style=" background-color:#00a98f; color: white; float: left; ">
					<div class="row">
						...
						<div class="col-sm-12 pt-2"><h5 align="center">Bonus Lembur</h5></div>
